        ...
        try:
            if self.path.endswith("/restaurants/new"):
                ...
                if ctype == 'multipart/form-data':
                    ...
                    # Create new Restaurant Object, has to make the messagecontent to string, the decode func
                    # if not, it will write the names as bytes into the database therefore cause probs
